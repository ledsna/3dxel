    ...
    public class CustomShaderGUI : CustomLitShader
    {
        ...
        private void DrawCustomProperties()
        {
            ...
            if (showCelShadingHeader) {
                ...
                materialEditor.ShaderProperty(_DistanceSteps, "Received Light Distance Attenuation Steps");
                materialEditor.ShaderProperty(_ShadowSteps, "Received Shadow Attenuation Steps");
