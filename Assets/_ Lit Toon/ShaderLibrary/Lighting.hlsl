    ...
    half clearCoatMask, bool specularHighlightsOff)
{
    ...
    half3 diffuse = lightColor * Quantize(_DiffuseSpecularCelShader ? _DiffuseSteps : -1, NdotL) * Quantize(_ShadowSteps, shadowAttenuation) * Quantize(_DistanceSteps, distanceAttenuation);
